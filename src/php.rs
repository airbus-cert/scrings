    ...
    fn parse(&mut self, src: &str) -> Result<Option<(u64, String)>> {
        ...
        let mut detection_rule = LanguageVisitor::new(|c| {
            matches!(c,
                ...
                "declare_statement" | "echo_statement" |
                "unset_statement" | "const_declaration" |
                "function_definition" | "class_declaration" |
                "interface_declaration" | "trait_declaration" |
                "enum_declaration" | "namespace_definition" |
                "namespace_use_declaration" | "global_declaration" |
                "function_static_declaration" | "assignment_expression" |
                "require_expression" | "require_once_expression" | "match_expression"
            )
        }
        );
